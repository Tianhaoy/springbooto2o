...
public class LocalAuthController {
    ...
    private Map<String, Object> bindLocalAuth(HttpServletRequest request) {
        ...
        logger.debug("获取输入的帐号"+userName);
        // 获取输入的密码
        String password = HttpServletRequestUtil.getString(request, "password");
        logger.debug("获取输入的密码"+password);
    ...
    private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
        ...
        // 获取帐号
        String userName = HttpServletRequestUtil.getString(request, "userName");
        logger.debug("获取帐号信息"+userName);
        // 获取原密码
        String password = HttpServletRequestUtil.getString(request, "password");
        logger.debug("获取原密码"+password);
        // 获取新密码
        String newPassword = HttpServletRequestUtil.getString(request, "newPassword");
        logger.debug("获取新密码"+newPassword);
        // 从session中获取当前用户信息(用户一旦通过微信登录之后，便能获取到用户的信息)
        PersonInfo user = (PersonInfo) request.getSession().getAttribute("user");
        logger.debug("用户信息为"+user);
        ...
        if (userName != null && password != null && newPassword != null && user != null && user.getUserId() != null
            ...
            try {
                ...
                modelMap.put("success", false);
                modelMap.put("errMsg", "更改密码失败，请检查密码是否输入正确！");
