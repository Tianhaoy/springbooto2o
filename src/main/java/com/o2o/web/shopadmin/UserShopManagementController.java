...
public class UserShopManagementController {
    private static Logger logger = LoggerFactory.getLogger(UserShopManagementController.class);
    @Autowired
    ...
    private Map<String, Object> listUserShopMapsByShop(HttpServletRequest request) {
        ...
        if ((pageIndex > -1) && (pageSize > -1) && (currentShop != null) && (currentShop.getShopId() != null)) {
            ...
            logger.debug("该店铺下的顾客积分列表"+ue.getUserShopMapList());
